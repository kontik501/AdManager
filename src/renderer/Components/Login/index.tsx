...
export default function LoginPage(){
    ...
    const handleRegisterUser = (e: any) => {
        ...
        attemptRegisterUser({ email, firstname, secondname, password }).then(() => {
            changeCurrentPage();
        })
    };
    ...
    const renderLogin = () => {
        return(
            <Fragment>
                <AnimatePresence>
                <motion.div className='login-container' key={"login"}
                initial={{ y: "100vh" }}
                animate={{ y: 0 }}
                exit={{ y: "100vh" }}
                transition={{ duration: 1 }}>
                    ...
                    <div className="form-container">
                        ...
                        <p className="sign-up-label">
                            Don't have an account?<span className="sign-up-link" onClick={ ()=> setReg(true)}>Sign up</span>
                        </p>
    ...
    const renderReg = () => {
        return(
            <Fragment>
                <AnimatePresence>
                <motion.div className='reg-container' key={"register"}
                initial={{ y: "-100vh" }}
                animate={{ y: 0 }}
                exit={{ y: "-100vh" }}
                transition={{ duration: 1 }}>
                    ...
                    <div className="reg form-container">
                        ...
                        <form className="form" onSubmit={ handleRegisterUser }>
                            <input id='email' type="email" className="input" placeholder="Email" />
                            <input id='firstname' type="firstname" className="input" placeholder="First Name" />
                            <input id='secondname' type="secondname" className="input" placeholder="Second Name" />
                            <input id='password' type="password" className="input" placeholder="Password" />
                            <p className="page-link">
                            </p>
                        ...
                        <p className="sign-up-label">
                            Already have an account?<span className="sign-up-link" onClick={ ()=> setReg(false)}>Log in</span>
                        </p>
                        <div className="buttons-container">
                            <div className="apple-login-button">
                            <svg stroke="currentColor" fill="currentColor" strokeWidth="0" className="apple-icon" viewBox="0 0 1024 1024" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
